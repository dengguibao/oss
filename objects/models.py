...
class Objects(models.Model):
    ...
    bucket = models.ForeignKey(Buckets, on_delete=models.CASCADE, null=False, blank=False)
    ...
    owner = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True, related_name='objects')
